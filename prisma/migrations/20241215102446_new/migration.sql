...
-- AlterTable
ALTER TABLE "allocation" ALTER COLUMN "studentId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "roomRequest" ALTER COLUMN "StudentId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "student" ALTER COLUMN "studentId" SET DATA TYPE TEXT;
